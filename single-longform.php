		...
		<?php
			...
			jQuery(function($){
			  $("#slider-' . $post->ID . '").owlCarousel({
				...
				$sldrimg = '';
				$caption = '';
				$child_thumb = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'large');
				...
				<div class="child_content">
					<div class="author-detail">
						...
						<ul class="author-social pull-right">
							<li><button class="btn" id="copylink1_<?php echo $post->ID ?>">Link másolása</button></li>
							<li><a class="google" target="_blank" href="https://news.google.com/publications/CAAqBwgKMKulmQswy6-xAw?hl=hu&gl=HU&ceid=HU%253Ahu">Google hírek</a></li>
						</ul>
				...
				<?php //the_excerpt(); 
					...
					<div class="post-social clr">
						...
						<ul class="social-sharing">
							<li><button class="btn" id="copylink_<?php echo $post->ID ?>">Link másolása</button></li>
							<li><a class="google" target="_blank" href="https://news.google.com/publications/CAAqBwgKMKulmQswy6-xAw?hl=hu&gl=HU&ceid=HU%253Ahu">Google hírek</a></li>
							<li></li>
						</ul>

					</div>
					<div class="related_post"><?php //echo do_shortcode( '[crp limit=2 heading=1]' );
													?> <?php echo do_shortcode('[recommended_articles]'); ?></div>
