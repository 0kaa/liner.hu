...
<main>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>A fenébe! Úgy tűnik, eltévedtél.</h2>
        <p>A jelek szerint az általad keresett oldal nem elérhető.
          Nem tudjuk, hogy jutottál ide, de ha már itt jársz, javasoljuk, hogy nézz szét címlapunkon, ahol számos érdekes hírt találsz.
        </p>

       <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="navbar-brand btn button " title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">CÍMLAP</a>
      </div>
    </div>
  </div>
</main>
		...
		<div id="content" role="main">
			...
			<article id="post-0" class="post error404 no-results not-found">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'This is somewhat embarrassing, isn&rsquo;t it?', 'liner' ); ?></h1>
				</header>

				<div class="entry-content">
					<p><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'liner' ); ?></p>
					<?php get_search_form(); ?>
				</div>
			</article>
